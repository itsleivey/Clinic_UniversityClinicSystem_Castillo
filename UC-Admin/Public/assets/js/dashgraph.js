            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: values,
                        backgroundColor: [
                            '#4fd1c5', '#63b3ed', '#fbd38d', '#b794f4',
                            '#ed8936', '#9b2c2c', '#f56565', '#48bb78',
                            '#4299e1', '#ed64a6', '#ecc94b', '#a0aec0',
                            '#38b2ac', '#9f7aea', '#f6ad55', '#e53e3e',
                            '#3182ce', '#2f855a', '#c53030', '#805ad5',
                            '#f687b3', '#81e6d9', '#cbd5e0', '#fc8181'
                        ],
                        borderRadius: 3,
                        barPercentage: 0.4,
...
document.addEventListener('DOMContentLoaded', function() {
    fetch('dashboard.dbf/fam_med_graph.php')
        ...
        .then(data => {
            const labels = Object.keys(data);
            const values = Object.values(data);
            const ctx = document.getElementById('familyMedicalChart').getContext('2d');
...
document.addEventListener('DOMContentLoaded', function() {
    fetch('dashboard.dbf/pers_soc_graph.php')
        ...
        .then(data => {
            ...
            const ctx = document.getElementById('personalSocialChart').getContext('2d');
    ...
    function loadConsultationChart(year) {
        fetch(`dashboard.dbf/consultation_graph.php?year=${year}`)
            ...
            .catch(error => {
                ...
                chartContainer.innerHTML = '<p class="error">Failed to load chart data.</p>';
            });
    }
